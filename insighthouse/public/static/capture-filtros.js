(() => {
  ...
  onReady(function () {
    ...
    ["dormitorios[]", "suites[]", "banheiros[]", "vagas[]"].forEach(function (
      name
    ) {
  ...
  document.addEventListener(
    ...
    function (e) {
      ...
      if (
        id === "input-slider-valor-venda" ||
        id === "input-slider-valor-aluguel" ||
        id === "input-slider-area"
      )
  ...
  var captureSubmit = function (source) {
    ...
    capture("search_submit", {
      ...
      preco_min:
        getVal("input-slider-valor-venda") ||
